...
class DataLoaderOrder {
    ...
    static final int TICKER_SYMBOL_CHECKER = TICKER_SYMBOL_LOADER + 1;
    static final int TICKER_CACHE_LOADER = TICKER_SYMBOL_CHECKER + 1;
    ...
    static final int ANALYZER_EVENT_DATA_LOADER = TICKER_HISTORICAL_FUNDAMENTALS_LOADER + 1;
}
